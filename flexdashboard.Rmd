...
graph2 <- ggplot() +
  ...
  annotate("segment", x = "1990", xend = "1997",y = 305, yend = 305,
           arrow = arrow(ends = "both", angle = 90),colour = "#F8766D") + 
  geom_text(aes(x="1995",y=310),label="Islamic groups (GIA)", nudge_x = 0.05, nudge_y = 0.05, check_overlap = T,col="#F8766D")+
  annotate("segment", x = "1972", xend = "1980",y = 315, yend = 315,
           arrow = arrow(ends = "both", angle = 90),colour = "#7CAE00") + 
  geom_text(aes(x="1976",y=320),label="years of Lead", nudge_x = 0.05, nudge_y = 0.05, check_overlap = T,col="#7CAE00")+
  annotate("segment", x = "1970", xend = "1998",y = 325, yend = 325,
           arrow = arrow(ends = "both", angle = 90),colour = "#C77CFF") + 
  geom_text(aes(x="1984",y=330),label="The Troubles (IRA)", nudge_x = 0.05, nudge_y = 0.05, check_overlap = T,col="#C77CFF")+
  annotate("segment", x = "1970", xend = "2001",y = 335, yend = 335,
           arrow = arrow(ends = "both", angle = 90),colour = "#00BFC4") + 
  geom_text(aes(x="1991",y=340),label="Basque nationalism (ETA)", nudge_x = 0.05, nudge_y = 0.05, check_overlap = T,col="#00BFC4")+
  annotate("segment", x = "2004", xend = "2017",y = 305, yend = 305,
           arrow = arrow(ends = "both", angle = 90),colour = "grey30") + 
  geom_text(aes(x="2010",y=310),label="Radical islamic terrorism", nudge_x = 0.05, nudge_y = 0.05, check_overlap = T,col="grey30")+
